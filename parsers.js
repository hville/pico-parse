...
function ruleOfN(peek, rs, id) {
	const r = Object.create(proto)
	if (id?.startsWith) r.id = id
	else if (rs.length === 1) return resolve(rs[0])
	r.peek = peek
	r.rs = rs.map( resolve )
	return r
}
...
/* any e0 / e1 / ... / en */
export function any(...rs) {
	return ruleOfN(anyP, rs, this)
}
function anyP(t,i=0) {
...
/* sequence e0 e1 ... en */
export function seq(...rs) {
	return ruleOfN(seqP, rs, this)
}
function seqP(t,i=0) {
	const tree = []
	let j = i
...
/* &(e0 ... en) */
export function and(...rs) {
	return ruleOf1(andP, rs, this)
}
function andP(t,i=0) {
...
/* !(e0 ... en) */
export function not(...rs) {
	return ruleOf1(notP, rs, this)
}
function notP(t,i=0) {
...
/* (e0 ... en)+ */
export function few(...rs) {
	return ruleOf1(fewP, rs, this)
}
function fewP(t,i=0) {
	const tree = [],
				r = this.rs
...
/* (e0 ... en)? */
export function opt(...rs) {
	return ruleOf1(optP, rs, this)
}
function optP(t,i=0) {
	if (i>t.length) return this.out(i,-1)
